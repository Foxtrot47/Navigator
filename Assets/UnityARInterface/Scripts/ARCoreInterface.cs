...
#region ARCoreCameraAPI
        ...
        private List<DetectedPlane> m_TrackedPlaneBuffer = new List<DetectedPlane>();
        private ScreenOrientation m_CachedScreenOrientation;
        private Dictionary<DetectedPlane, BoundedPlane> m_TrackedPlanes = new Dictionary<DetectedPlane, BoundedPlane>();
        ...
        private bool PlaneUpdated(DetectedPlane tp, BoundedPlane bp)
        {
